...
const EnhanceDatePicker: React.FC<EnhanceDatePickerProps> = ({
	isOpen = false,
	onCancel,
	...props
}) => {
	...
	const handleStart: React.MouseEventHandler<HTMLDivElement> &
		React.TouchEventHandler<HTMLDivElement> = (e) => {
	...
	return (
		<div
			...
			className='vuivui-datepicker-modal'
		>
			<DatePicker {...props} />
		</div>
	);
...
type ModalDatePickerProps = EnhanceDatePickerProps &
	DatePickerProps & {
		isPopup?: boolean;
	};
