...
const CartOutofStockMobile: React.FC<IsOutOfStock> = ({
	isOutofStock,
	dataOutOfStock,
	totalItems,
	onClose,
		...
		>
			...
			<div className='flex flex-col justify-center'>
				...
				<div className='flex items-center gap-4 px-4 pb-[8px]'>
					...
					<div className={`flex-auto ${!Boolean(dataOutOfStock?.length) && 'cursor-not-allowed'}`}>
						{dataOutOfStock?.length === totalItems ? (
							<Link href={'/'}>
								<button
...
export default CartOutofStockMobile;
